...
var X3 = (p, t, i) => t in p ? Q3(p, t, { enumerable: true, configurable: true, writable: true, value: i }) : p[t] = i;
var v = (p, t, i) => X3(p, typeof t != "symbol" ? t + "" : t, i);
var a2 = class {
...
var s2 = class {
  constructor() {
    v(this, "_lastHandleId", 0);
    v(this, "_lastImmediate", null);
  }
  requestAnimationFrame(t) {
...
var k1 = class {
  constructor() {
    v(this, "_strategy");
    this._strategy = typeof requestAnimationFrame == "function" ? new a2() : new s2();
  }
  requestAnimationFrame(t) {
...
var X2 = ["v", "ip", "op", "layers", "fr", "w", "h"];
var o2 = "0.58.1";
var u2 = "@lottiefiles/dotlottie-web";
var Z2 = 0.75;
var e3 = 4;
var Z3 = (() => {
  ...
  return function(t = {}) {
    var i;
    function u(e, n, r) {
      return (n = l(n)) in e ? Object.defineProperty(e, n, { value: r, enumerable: true, configurable: true, writable: true }) : e[n] = r, e;
    }
    function l(e) {
      var n = M(e, "string");
    ...
    var d = t, Q, t1, n1 = new Promise((e, n) => {
      Q = e, t1 = n;
    }), _2 = Object.assign({}, d), g22 = "./this.program", j = "", b2;
    typeof document < "u" && document.currentScript && (j = document.currentScript.src), p && (j = p), j.startsWith("blob:") ? j = "" : j = j.substr(0, j.replace(/[?#].*/, "").lastIndexOf("/") + 1), b2 = async (e) => {
      if (e = await fetch(e, { credentials: "same-origin" }), e.ok) return e.arrayBuffer();
      throw Error(e.status + " : " + e.url);
    };
    var u1 = d.printErr || console.error.bind(console);
    Object.assign(d, _2), _2 = null, d.thisProgram && (g22 = d.thisProgram);
    var b1 = d.wasmBinary, M1, y1 = false, W1, i1, x, r1, d1, X, w, M2, y2;
    function C2() {
      var e = M1.buffer;
      d.HEAP8 = i1 = new Int8Array(e), d.HEAP16 = r1 = new Int16Array(e), d.HEAPU8 = x = new Uint8Array(e), d.HEAPU16 = d1 = new Uint16Array(e), d.HEAP32 = X = new Int32Array(e), d.HEAPU32 = w = new Uint32Array(e), d.HEAPF32 = M2 = new Float32Array(e), d.HEAPF64 = y2 = new Float64Array(e);
    }
    var L2 = [], w2 = [], E2 = [];
    function u3() {
    ...
    function C1(e) {
      var n;
      throw (n = d.onAbort) === null || n === void 0 || n.call(d, e), e = "Aborted(" + e + ")", u1(e), y1 = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), t1(e), e;
    }
    var I2 = (e) => e.startsWith("data:application/octet-stream;base64,"), L1;
    async function d3(e) {
      if (!b1) try {
        var n = await b2(e);
      ...
      if (e == L1 && b1) e = new Uint8Array(b1);
      else throw "both async and sync fetching of the wasm failed";
      return e;
    }
    async function h3(e, n) {
      try {
        var r = await d3(e);
        return await WebAssembly.instantiate(r, n);
      } catch (a) {
        u1(`failed to asynchronously prepare wasm: ${a}`), C1(a);
      }
    }
    async function c3(e) {
      var n = L1;
      if (!b1 && typeof WebAssembly.instantiateStreaming == "function" && !I2(n) && typeof fetch == "function") try {
        var r = fetch(n, { credentials: "same-origin" });
        return await WebAssembly.instantiateStreaming(r, e);
      } catch (a) {
        u1(`wasm streaming compile failed: ${a}`), u1("falling back to ArrayBuffer instantiation");
      }
      return h3(n, e);
    }
    class S2 {
      constructor(n) {
        u(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${n})`, this.status = n;
      }
    }
    var $1 = (e) => {
      for (; 0 < e.length; ) e.shift()(d);
    }, H1 = d.noExitRuntime || true, P2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, w1 = function() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN;
      var r = x, a = e + n;
      for (n = e; r[n] && !(n >= a); ) ++n;
      if (16 < n - e && r.buffer && P2) return P2.decode(r.subarray(e, n));
      for (a = ""; e < n; ) {
        var s = r[e++];
        if (s & 128) {
          var o = r[e++] & 63;
          if ((s & 224) == 192) a += String.fromCharCode((s & 31) << 6 | o);
          else {
            var c = r[e++] & 63;
            s = (s & 240) == 224 ? (s & 15) << 12 | o << 6 | c : (s & 7) << 18 | o << 12 | c << 6 | r[e++] & 63, 65536 > s ? a += String.fromCharCode(s) : (s -= 65536, a += String.fromCharCode(55296 | s >> 10, 56320 | s & 1023));
          }
    ...
    var a1 = {}, e1 = {}, I1 = {}, p1, q = (e, n, r) => {
      function a(h) {
        if (h = r(h), h.length !== e.length) throw new p1("Mismatched type converter count");
        for (var f = 0; f < e.length; ++f) U(e[f], h[f]);
      }
      e.forEach((h) => I1[h] = n);
      var s = Array(n.length), o = [], c = 0;
      n.forEach((h, f) => {
        e1.hasOwnProperty(h) ? s[f] = e1[h] : (o.push(h), a1.hasOwnProperty(h) || (a1[h] = []), a1[h].push(() => {
          s[f] = e1[h], ++c, c === o.length && a(s);
        }));
      }), o.length === 0 && a(s);
    }, T2, P = (e) => {
      for (var n = ""; x[e]; ) n += T2[x[e++]];
      return n;
    }, b;
    function f3(e, n) {
      let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var a = n.name;
      if (!e) throw new b(`type "${a}" must have a positive integer typeid pointer`);
      if (e1.hasOwnProperty(e)) {
        if (r.hb) return;
        throw new b(`Cannot register type '${a}' twice`);
      }
      e1[e] = n, delete I1[e], a1.hasOwnProperty(e) && (n = a1[e], delete a1[e], n.forEach((s) => s()));
    }
    function U(e, n) {
      let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      return f3(e, n, r);
    ...
    var j1 = (e) => {
      throw new b(e.Aa.Da.Ba.name + " instance already deleted");
    }, N1 = false, A2 = () => {
    }, F2 = (e, n, r) => n === r ? e : r.Ga === void 0 ? null : (e = F2(e, n, r.Ga), e === null ? null : r.$a(e)), x2 = {}, v3 = {}, m3 = (e, n) => {
      if (n === void 0) throw new b("ptr should not be undefined");
      for (; e.Ga; ) n = e.Qa(n), e = e.Ga;
      return v3[n];
    }, S1 = (e, n) => {
      if (!n.Da || !n.Ca) throw new p1("makeClassHandle requires ptr and ptrType");
      if (!!n.Ha != !!n.Fa) throw new p1("Both smartPtrType and smartPtr must be specified");
      return n.count = { value: 1 }, f1(Object.create(e, { Aa: { value: n, writable: true } }));
    }, f1 = (e) => typeof FinalizationRegistry > "u" ? (f1 = (n) => n, e) : (N1 = new FinalizationRegistry((n) => {
      n = n.Aa, --n.count.value, n.count.value === 0 && (n.Fa ? n.Ha.Ka(n.Fa) : n.Da.Ba.Ka(n.Ca));
    }), f1 = (n) => {
      var r = n.Aa;
      return r.Fa && N1.register(n, { Aa: r }, n), n;
    }, A2 = (n) => {
      N1.unregister(n);
    }, f1(e));
    function P1() {
    }
    var v1 = (e, n) => Object.defineProperty(n, "name", { value: e }), D2 = (e, n, r) => {
      if (e[n].Ea === void 0) {
        var a = e[n];
        e[n] = function() {
          for (var s = arguments.length, o = new Array(s), c = 0; c < s; c++) o[c] = arguments[c];
          if (!e[n].Ea.hasOwnProperty(o.length)) throw new b(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[n].Ea})!`);
          return e[n].Ea[o.length].apply(this, o);
        }, e[n].Ea = [], e[n].Ea[a.Na] = a;
      }
    }, G1 = (e, n, r) => {
      if (d.hasOwnProperty(e)) {
        if (r === void 0 || d[e].Ea !== void 0 && d[e].Ea[r] !== void 0) throw new b(`Cannot register public name '${e}' twice`);
        if (D2(d, e, e), d[e].Ea.hasOwnProperty(r)) throw new b(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        d[e].Ea[r] = n;
      } else d[e] = n, d[e].Na = r;
    }, g3 = (e) => {
    ...
    function b3(e, n, r, a, s, o, c, h) {
      this.name = e, this.constructor = n, this.Ma = r, this.Ka = a, this.Ga = s, this.bb = o, this.Qa = c, this.$a = h, this.jb = [];
    }
    var J1 = (e, n, r) => {
      for (; n !== r; ) {
        if (!n.Qa) throw new b(`Expected null or instance of ${r.name}, got an instance of ${n.name}`);
        e = n.Qa(e), n = n.Ga;
      }
      return e;
    };
    function M3(e, n) {
      if (n === null) {
        if (this.Ta) throw new b(`null is not a valid ${this.name}`);
        return 0;
      }
      if (!n.Aa) throw new b(`Cannot pass "${X1(n)}" as a ${this.name}`);
      if (!n.Aa.Ca) throw new b(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return J1(n.Aa.Ca, n.Aa.Da.Ba, this.Ba);
    }
    function y3(e, n) {
      if (n === null) {
        if (this.Ta) throw new b(`null is not a valid ${this.name}`);
      ...
      if (!n || !n.Aa) throw new b(`Cannot pass "${X1(n)}" as a ${this.name}`);
      if (!n.Aa.Ca) throw new b(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && n.Aa.Da.Ra) throw new b(`Cannot convert argument of type ${n.Aa.Ha ? n.Aa.Ha.name : n.Aa.Da.name} to parameter type ${this.name}`);
      if (r = J1(n.Aa.Ca, n.Aa.Da.Ba, this.Ba), this.Sa) {
        if (n.Aa.Fa === void 0) throw new b("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (n.Aa.Ha === this) r = n.Aa.Fa;
            else throw new b(`Cannot convert argument of type ${n.Aa.Ha ? n.Aa.Ha.name : n.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            r = n.Aa.Fa;
            break;
          case 2:
            if (n.Aa.Ha === this) r = n.Aa.Fa;
              ...
              var a = n.clone();
              r = this.kb(r, T1(() => a.delete())), e !== null && e.push(this.Ka, r);
            }
            break;
          default:
    ...
    function C3(e, n) {
      ...
      if (!n.Aa) throw new b(`Cannot pass "${X1(n)}" as a ${this.name}`);
      if (!n.Aa.Ca) throw new b(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (n.Aa.Da.Ra) throw new b(`Cannot convert argument of type ${n.Aa.Da.name} to parameter type ${this.name}`);
      return J1(n.Aa.Ca, n.Aa.Da.Ba, this.Ba);
    }
    function m1(e, n, r, a, s, o, c, h, f, _, m) {
      this.name = e, this.Ba = n, this.Ta = r, this.Ra = a, this.Sa = s, this.ib = o, this.ob = c, this.Ya = h, this.Ua = f, this.kb = _, this.Ka = m, s || n.Ga !== void 0 ? this.toWireType = y3 : (this.toWireType = a ? M3 : C3, this.Ja = null);
    }
    var R2 = (e, n, r) => {
      if (!d.hasOwnProperty(e)) throw new p1("Replacing nonexistent public symbol");
      d[e].Ea !== void 0 && r !== void 0 ? d[e].Ea[r] = n : (d[e] = n, d[e].Na = r);
    }, k, L3 = function(e, n) {
      let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return e.includes("j") ? (e = e.replace(/p/g, "i"), n = (0, d["dynCall_" + e])(n, ...r)) : n = k.get(n)(...r), n;
    }, w3 = (e, n) => function() {
      for (var r = arguments.length, a = new Array(r), s = 0; s < r; s++) a[s] = arguments[s];
      return L3(e, n, a);
    }, O = (e, n) => {
      e = P(e);
      var r = e.includes("j") ? w3(e, n) : k.get(n);
      if (typeof r != "function") throw new b(`unknown function pointer with signature ${e}: ${n}`);
      return r;
    }, k2, B2 = (e) => {
      e = J2(e);
      var n = P(e);
      ...
      function r(o) {
        s[o] || e1[o] || (I1[o] ? I1[o].forEach(r) : (a.push(o), s[o] = true));
      }
      var a = [], s = {};
      throw n.forEach(r), new k2(`${e}: ` + a.map(B2).join([", "]));
    }, q1 = (e, n) => {
      for (var r = [], a = 0; a < e; a++) r.push(w[n + 4 * a >> 2]);
      return r;
    };
    function E3(e) {
      for (var n = 1; n < e.length; ++n) if (e[n] !== null && e[n].Ja === void 0) return true;
      return false;
    }
    function K1(e, n, r, a, s) {
      var o = n.length;
      if (2 > o) throw new b("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var c = n[1] !== null && r !== null, h = E3(n), f = n[0].name !== "void", _ = o - 2, m = Array(_), y = [], C = [];
      return v1(e, function() {
        for (var B = arguments.length, E = new Array(B), z = 0; z < B; z++) E[z] = arguments[z];
        if (C.length = 0, y.length = c ? 2 : 1, y[0] = s, c) {
          var D = n[1].toWireType(C, this);
          y[1] = D;
        }
        for (var S = 0; S < _; ++S) m[S] = n[S + 2].toWireType(C, E[S]), y.push(m[S]);
        if (E = a(...y), h) V1(C);
        else for (S = c ? 1 : 2; S < n.length; S++) {
          var T = S === 1 ? D : m[S - 2];
          n[S].Ja !== null && n[S].Ja(T);
        }
        return D = f ? n[0].fromWireType(E) : void 0, D;
      });
    }
    var U2 = (e) => {
      e = e.trim();
      ...
      9 < e && --N[e + 1] === 0 && (N[e] = void 0, Y1.push(e));
    }, s1 = (e) => {
      ...
      switch (e) {
        ...
        case false:
          return 8;
        default:
          let n = Y1.pop() || N.length;
          return N[n] = e, N[n + 1] = 1, n;
      }
    }, z2 = { name: "emscripten::val", fromWireType: (e) => {
      var n = s1(e);
      return Q1(e), n;
    }, toWireType: (e, n) => T1(n), Ia: 8, readValueFromPointer: l1, Ja: null }, I3 = (e, n, r) => {
      switch (n) {
        case 1:
          return r ? function(a) {
            return this.fromWireType(i1[a]);
          } : function(a) {
      ...
      var r = e1[e];
      if (r === void 0) throw e = `${n} has unknown type ${B2(e)}`, new b(e);
      return r;
    }, X1 = (e) => {
      ...
      switch (n) {
        ...
        case 8:
          return function(r) {
            return this.fromWireType(y2[r >> 3]);
          };
        default:
      ...
      switch (n) {
        case 1:
          return r ? (a) => i1[a] : (a) => x[a];
        case 2:
          return r ? (a) => r1[a >> 1] : (a) => d1[a >> 1];
        case 4:
          return r ? (a) => X[a >> 2] : (a) => w[a >> 2];
        default:
          throw new TypeError(`invalid integer width (${n}): ${e}`);
      }
    }, O3 = Object.assign({ optional: true }, z2), W22 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, T3 = (e, n) => {
      for (var r = e >> 1, a = r + n / 2; !(r >= a) && d1[r]; ) ++r;
      if (r <<= 1, 32 < r - e && W22) return W22.decode(x.subarray(e, r));
      for (r = "", a = 0; !(a >= n / 2); ++a) {
        var s = r1[e + 2 * a >> 1];
        if (s == 0) break;
      ...
      var a;
      if ((a = r) !== null && a !== void 0 || (r = 2147483647), 2 > r) return 0;
      r -= 2;
      var s = n;
      r = r < 2 * e.length ? r / 2 : e.length;
      for (var o = 0; o < r; ++o) r1[n >> 1] = e.charCodeAt(o), n += 2;
      return r1[n >> 1] = 0, n - s;
    }, F3 = (e) => 2 * e.length, x3 = (e, n) => {
      for (var r = 0, a = ""; !(r >= n / 4); ) {
        var s = X[e + 4 * r >> 2];
        if (s == 0) break;
      ...
      var a;
      if ((a = r) !== null && a !== void 0 || (r = 2147483647), 4 > r) return 0;
      var s = n;
      r = s + r - 4;
      for (var o = 0; o < e.length; ++o) {
        ...
        if (55296 <= c && 57343 >= c) {
          ...
          c = 65536 + ((c & 1023) << 10) | h & 1023;
        }
        if (X[n >> 2] = c, n += 4, n + 4 > r) break;
      }
      return X[n >> 2] = 0, n - s;
    }, R3 = (e) => {
      ...
      var a = [];
      return e = e.toWireType(a, r), a.length && (w[n >> 2] = T1(a)), e;
    }, e2 = [], k3 = (e) => {
      var n = e2.length;
      return e2.push(e), n;
    }, B3 = (e, n) => {
      for (var r = Array(e), a = 0; a < e; ++a) r[a] = A1(w[n + 4 * a >> 2], "parameter " + a);
      return r;
    }, U3 = Reflect.construct, _1 = {}, H2 = (e) => {
      if (!(e instanceof S2 || e == "unwind")) throw e;
    }, V2 = (e) => {
      var n;
      throw W1 = e, H1 || 0 < Z1 || ((n = d.onExit) !== null && n !== void 0 && n.call(d, e), y1 = true), new S2(e);
    }, z3 = (e) => {
      if (!y1) try {
        if (e(), !(H1 || 0 < Z1)) try {
          W1 = e = W1, V2(e);
      ...
      if (!n2) {
        var e = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: g22 || "./this.program" }, n;
        for (n in t2) t2[n] === void 0 ? delete e[n] : e[n] = t2[n];
        var r = [];
    ...
    for (var G2 = Array(256), F1 = 0; 256 > F1; ++F1) G2[F1] = String.fromCharCode(F1);
    T2 = G2, b = d.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign(P1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof P1 && e instanceof P1)) return false;
      var n = this.Aa.Da.Ba, r = this.Aa.Ca;
      e.Aa = e.Aa;
      var a = e.Aa.Da.Ba;
      for (e = e.Aa.Ca; n.Ga; ) r = n.Qa(r), n = n.Ga;
      for (; a.Ga; ) e = a.Qa(e), a = a.Ga;
      return n === a && r === e;
    }, clone: function() {
      if (this.Aa.Ca || j1(this), this.Aa.Pa) return this.Aa.count.value += 1, this;
      var e = f1, n = Object, r = n.create, a = Object.getPrototypeOf(this), s = this.Aa;
      return e = e(r.call(n, a, { Aa: { value: { count: s.count, Oa: s.Oa, Pa: s.Pa, Ca: s.Ca, Da: s.Da, Fa: s.Fa, Ha: s.Ha } } })), e.Aa.count.value += 1, e.Aa.Oa = false, e;
    }, delete() {
      if (this.Aa.Ca || j1(this), this.Aa.Oa && !this.Aa.Pa) throw new b("Object already scheduled for deletion");
      A2(this);
      var e = this.Aa;
      --e.count.value, e.count.value === 0 && (e.Fa ? e.Ha.Ka(e.Fa) : e.Da.Ba.Ka(e.Ca)), this.Aa.Pa || (this.Aa.Fa = void 0, this.Aa.Ca = void 0);
    }, isDeleted: function() {
      return !this.Aa.Ca;
    }, deleteLater: function() {
      if (this.Aa.Ca || j1(this), this.Aa.Oa && !this.Aa.Pa) throw new b("Object already scheduled for deletion");
      return this.Aa.Oa = true, this;
    } }), Object.assign(m1.prototype, { cb(e) {
      return this.Ya && (e = this.Ya(e)), e;
    }, Wa(e) {
      var n;
      (n = this.Ka) === null || n === void 0 || n.call(this, e);
    }, Ia: 8, readValueFromPointer: l1, fromWireType: function(e) {
      function n() {
        return this.Sa ? S1(this.Ba.Ma, { Da: this.ib, Ca: r, Ha: this, Fa: e }) : S1(this.Ba.Ma, { Da: this, Ca: e });
      }
      var r = this.cb(e);
      if (!r) return this.Wa(e), null;
      var a = m3(this.Ba, r);
      if (a !== void 0) return a.Aa.count.value === 0 ? (a.Aa.Ca = r, a.Aa.Fa = e, a.clone()) : (a = a.clone(), this.Wa(e), a);
      if (a = this.Ba.bb(r), a = x2[a], !a) return n.call(this);
      a = this.Ra ? a.Za : a.pointerType;
      var s = F2(r, this.Ba, a.Ba);
      return s === null ? n.call(this) : this.Sa ? S1(a.Ba.Ma, { Da: a, Ca: s, Ha: this, Fa: e }) : S1(a.Ba.Ma, { Da: a, Ca: s });
    } }), k2 = d.UnboundTypeError = ((e, n) => {
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    })(Error, "UnboundTypeError"), N.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), d.count_emval_handles = () => N.length / 2 - 5 - Y1.length;
    var $3 = { c: (e, n, r, a) => C1(`Assertion failed: ${e ? w1(e) : ""}, at: ` + [n ? n ? w1(n) : "" : "unknown filename", r, a ? a ? w1(a) : "" : "unknown function"]), j: (e, n, r) => {
      var a = new l3(e);
      throw w[a.Ca + 16 >> 2] = 0, w[a.Ca + 4 >> 2] = n, w[a.Ca + 8 >> 2] = r, O2 = e, O2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      var n = E1[e];
      delete E1[e];
      var r = n.Ua, a = n.Ka, s = n.Xa, o = s.map((c) => c.gb).concat(s.map((c) => c.mb));
      q([e], o, (c) => {
        var h = {};
        return s.forEach((f, _) => {
          var m = c[_], y = f.eb, C = f.fb, B = c[_ + s.length], E = f.lb, z = f.nb;
          h[f.ab] = { read: (D) => m.fromWireType(y(C, D)), write: (D, S) => {
            var T = [];
            E(z, D, B.toWireType(T, S)), V1(T);
          } };
        }), [{ name: n.name, fromWireType: (f) => {
          var _ = {}, m;
          for (m in h) _[m] = h[m].read(f);
          return a(f), _;
        }, toWireType: (f, _) => {
          for (var m in h) if (!(m in _)) throw new TypeError(`Missing field: "${m}"`);
          var y = r();
          for (m in h) h[m].write(y, _[m]);
          return f !== null && f.push(a, y), y;
        }, Ia: 8, readValueFromPointer: l1, Ja: a }];
      });
    }, F: () => {
    }, _: (e, n, r, a) => {
      n = P(n), U(e, { name: n, fromWireType: function(s) {
        return !!s;
    ...
    }, k: (e, n, r, a, s, o, c, h, f, _, m, y, C) => {
      m = P(m), o = O(s, o), h && (h = O(c, h)), _ && (_ = O(f, _)), C = O(y, C);
      var B = g3(m);
      G1(B, function() {
        O1(`Cannot construct ${m} due to unbound types`, [a]);
      }), q([e, n, r], a ? [a] : [], (E) => {
        if (E = E[0], a) var z = E.Ba, D = z.Ma;
        else D = P1.prototype;
        E = v1(m, function() {
          if (Object.getPrototypeOf(this) !== S) throw new b("Use 'new' to construct " + m);
          if (T.La === void 0) throw new b(m + " has no accessible constructor");
          for (var Y2 = arguments.length, D1 = new Array(Y2), R1 = 0; R1 < Y2; R1++) D1[R1] = arguments[R1];
          var Q2 = T.La[D1.length];
          if (Q2 === void 0) throw new b(`Tried to invoke ctor of ${m} with invalid number of parameters (${D1.length}) - expected (${Object.keys(T.La).toString()}) parameters instead!`);
          return Q2.apply(this, D1);
        });
        var S = Object.create(D, { constructor: { value: E } });
        E.prototype = S;
        var T = new b3(m, E, S, C, z, o, h, _);
        if (T.Ga) {
          var r2, g1;
          (r2 = (g1 = T.Ga).Va) !== null && r2 !== void 0 || (g1.Va = []), T.Ga.Va.push(T);
        }
        return z = new m1(m, T, true, false, false), g1 = new m1(m + "*", T, false, false, false), D = new m1(m + " const*", T, false, true, false), x2[e] = { pointerType: g1, Za: D }, R2(B, E), [z, g1, D];
      });
    }, r: (e, n, r, a, s, o) => {
      var c = q1(n, r);
      s = O(a, s), q([], [e], (h) => {
        h = h[0];
        var f = `constructor ${h.name}`;
        if (h.Ba.La === void 0 && (h.Ba.La = []), h.Ba.La[n - 1] !== void 0) throw new b(`Cannot register multiple constructors with identical number of parameters (${n - 1}) for class '${h.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return h.Ba.La[n - 1] = () => {
          O1(`Cannot construct ${h.name} due to unbound types`, c);
        }, q([], c, (_) => (_.splice(1, 0, null), h.Ba.La[n - 1] = K1(f, _, null, s, o), [])), [];
      });
    }, d: (e, n, r, a, s, o, c, h) => {
      var f = q1(r, a);
      n = P(n), n = U2(n), o = O(s, o), q([], [e], (_) => {
        function m() {
          O1(`Cannot call ${y} due to unbound types`, f);
        }
        _ = _[0];
        var y = `${_.name}.${n}`;
        n.startsWith("@@") && (n = Symbol[n.substring(2)]), h && _.Ba.jb.push(n);
        var C = _.Ba.Ma, B = C[n];
        return B === void 0 || B.Ea === void 0 && B.className !== _.name && B.Na === r - 2 ? (m.Na = r - 2, m.className = _.name, C[n] = m) : (D2(C, n, y), C[n].Ea[r - 2] = m), q([], f, (E) => (E = K1(y, E, _, o, c), C[n].Ea === void 0 ? (E.Na = r - 2, C[n] = E) : C[n].Ea[r - 2] = E, [])), [];
      });
    }, Y: (e) => U(e, z2), D: (e, n, r, a) => {
      function s() {
      }
      n = P(n), s.values = {}, U(e, { name: n, constructor: s, fromWireType: function(o) {
        return this.constructor.values[o];
      }, toWireType: (o, c) => c.value, Ia: 8, readValueFromPointer: I3(n, r, a), Ja: null }), G1(n, s);
    }, m: (e, n, r) => {
      var a = A1(e, "enum");
      n = P(n), e = a.constructor, a = Object.create(a.constructor.prototype, { value: { value: r }, constructor: { value: v1(`${a.name}_${n}`, function() {
      }) } }), e.values[r] = a, e[n] = a;
    }, A: (e, n, r) => {
      n = P(n), U(e, { name: n, fromWireType: (a) => a, toWireType: (a, s) => s, Ia: 8, readValueFromPointer: S3(n, r), Ja: null });
    }, u: (e, n, r, a, s, o) => {
      var c = q1(n, r);
      e = P(e), e = U2(e), s = O(a, s), G1(e, function() {
        O1(`Cannot call ${e} due to unbound types`, c);
      }, n - 1), q([], c, (h) => (R2(e, K1(e, [h[0], null].concat(h.slice(1)), null, s, o), n - 1), []));
    }, n: (e, n, r, a, s) => {
      if (n = P(n), s === -1 && (s = 4294967295), s = (h) => h, a === 0) {
        var o = 32 - 8 * r;
        s = (h) => h << o >>> o;
      }
      var c = n.includes("unsigned") ? function(h, f) {
        return f >>> 0;
      } : function(h, f) {
        return f;
      };
      U(e, { name: n, fromWireType: s, toWireType: c, Ia: 8, readValueFromPointer: P3(n, r, a !== 0), Ja: null });
    }, g: (e, n, r) => {
      function a(o) {
        return new s(i1.buffer, w[o + 4 >> 2], w[o >> 2]);
      }
      var s = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][n];
      r = P(r), U(e, { name: r, fromWireType: a, Ia: 8, readValueFromPointer: a }, { hb: true });
    }, o: (e) => {
      U(e, O3);
    }, v: (e, n, r, a, s, o, c, h, f, _, m, y) => {
      r = P(r), o = O(s, o), h = O(c, h), _ = O(f, _), y = O(m, y), q([e], [n], (C) => (C = C[0], [new m1(r, C.Ba, false, false, true, C, a, o, h, _, y)]));
    }, Z: (e, n) => {
      n = P(n), U(e, { name: n, fromWireType: function(r) {
        for (var a = w[r >> 2], s = r + 4, o, c = s, h = 0; h <= a; ++h) {
          var f = s + h;
          (h == a || x[f] == 0) && (c = c ? w1(c, f - c) : "", o === void 0 ? o = c : (o += "\0", o += c), c = f + 1);
        }
        return G(r), o;
      }, toWireType: function(r, a) {
        a instanceof ArrayBuffer && (a = new Uint8Array(a));
        var s, o = typeof a == "string";
        if (!(o || a instanceof Uint8Array || a instanceof Uint8ClampedArray || a instanceof Int8Array)) throw new b("Cannot pass non-string to std::string");
        if (o) for (var c = s = 0; c < a.length; ++c) {
          var h = a.charCodeAt(c);
          127 >= h ? s++ : 2047 >= h ? s += 2 : 55296 <= h && 57343 >= h ? (s += 4, ++c) : s += 3;
        }
        else s = a.length;
        if (c = i2(4 + s + 1), h = c + 4, w[c >> 2] = s, o) c1(a, h, s + 1);
        else if (o) for (o = 0; o < s; ++o) {
          var f = a.charCodeAt(o);
          if (255 < f) throw G(h), new b("String has UTF-16 code units that do not fit in 8 bits");
          x[h + o] = f;
        }
        else for (o = 0; o < s; ++o) x[h + o] = a[o];
        return r !== null && r.push(G, c), c;
      }, Ia: 8, readValueFromPointer: l1, Ja(r) {
        G(r);
      } });
    }, y: (e, n, r) => {
      if (r = P(r), n === 2) var a = T3, s = A3, o = F3, c = (h) => d1[h >> 1];
      else n === 4 && (a = x3, s = D3, o = R3, c = (h) => w[h >> 2]);
      U(e, { name: r, fromWireType: (h) => {
        for (var f = w[h >> 2], _, m = h + 4, y = 0; y <= f; ++y) {
          var C = h + 4 + y * n;
          (y == f || c(C) == 0) && (m = a(m, C - m), _ === void 0 ? _ = m : (_ += "\0", _ += m), m = C + n);
        }
        return G(h), _;
      }, toWireType: (h, f) => {
        if (typeof f != "string") throw new b(`Cannot pass non-string to C++ string type ${r}`);
        var _ = o(f), m = i2(4 + _ + n);
        return w[m >> 2] = _ / n, s(f, m + 4, _ + n), h !== null && h.push(G, m), m;
      }, Ia: 8, readValueFromPointer: l1, Ja(h) {
        G(h);
      } });
    }, x: (e, n, r, a, s, o) => {
      E1[e] = { name: P(n), Ua: O(r, a), Ka: O(s, o), Xa: [] };
    }, i: (e, n, r, a, s, o, c, h, f, _) => {
      E1[e].Xa.push({ ab: P(n), gb: r, eb: O(a, s), fb: o, mb: c, lb: O(h, f), nb: _ });
    }, $: (e, n) => {
      n = P(n), U(e, { pb: true, name: n, Ia: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, K: () => {
      H1 = false, Z1 = 0;
      ...
      throw 1 / 0;
    }, C: (e, n, r) => (e = s1(e), n = A1(n, "emval::as"), $2(n, r, e)), q: (e, n, r, a) => (e = e2[e], n = s1(n), e(null, n, r, a)), W: Q1, E: (e, n) => (e = s1(e), n = s1(n), e == n), p: (e, n, r) => {
      var a = B3(e, n), s = a.shift();
      e--;
      var o = Array(e);
      return n = `methodCaller<(${a.map((c) => c.name).join(", ")}) => ${s.name}>`, k3(v1(n, (c, h, f, _) => {
        for (var m = 0, y = 0; y < e; ++y) o[y] = a[y].readValueFromPointer(_ + m), m += a[y].Ia;
        return c = r === 1 ? U3(h, o) : h.apply(c, o), $2(s, f, c);
      }));
    }, z: (e) => {
      9 < e && (N[e + 1] += 1);
    }, ca: (e) => {
      var n = s1(e);
      V1(n), Q1(e);
    }, s: (e, n) => (e = A1(e, "_emval_take_value"), e = e.readValueFromPointer(n), T1(e)), G: (e, n) => {
      if (_1[e] && (clearTimeout(_1[e].id), delete _1[e]), !n) return 0;
      var r = setTimeout(() => {
        delete _1[e], z3(() => q2(e, performance.now()));
      }, n);
      return _1[e] = { id: r, qb: n }, 0;
    }, H: (e, n, r, a) => {
      var s = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(s, 0, 1).getTimezoneOffset();
      s = new Date(s, 6, 1).getTimezoneOffset(), w[e >> 2] = 60 * Math.max(o, s), X[n >> 2] = +(o != s), n = (c) => {
        var h = Math.abs(c);
        return `UTC${0 <= c ? "-" : "+"}${String(Math.floor(h / 60)).padStart(2, "0")}${String(h % 60).padStart(2, "0")}`;
      }, e = n(o), n = n(s), s < o ? (c1(e, r, 17), c1(n, a, 17)) : (c1(e, a, 17), c1(n, r, 17));
    }, ba: () => performance.now(), J: (e) => {
      var n = x.length;
      ...
      var r = 0;
      return j2().forEach((a, s) => {
        var o = n + r;
        for (s = w[e + 4 * s >> 2] = o, o = 0; o < a.length; ++o) i1[s++] = a.charCodeAt(o);
        i1[s] = 0, r += a.length + 1;
      }), 0;
    }, X: (e, n) => {
      var r = j2();
      w[e >> 2] = r.length;
      var a = 0;
      return r.forEach((s) => a += s.length + 1), w[n >> 2] = a, 0;
    }, S: () => 52, Q: () => 52, l: H3, f: G3, e: K3, B: V3, aa: q3, a: j3, b: J3, h: N3, t: Y3, U: V2, L: (e, n) => (N2(x.subarray(e, e + n)), 0) }, L;
    (async function(e, n) {
      function r(o) {
        var c;
        return L = o.exports, M1 = L.da, C2(), k = L.ga, w2.unshift(L.ea), Z--, (c = d.monitorRunDependencies) === null || c === void 0 || c.call(d, Z), Z == 0 && h1 && (o = h1, h1 = null, o()), L;
      }
      Z++, (e = d.monitorRunDependencies) === null || e === void 0 || e.call(d, Z);
      var a = { a: $3 };
      if (d.instantiateWasm) try {
        return d.instantiateWasm(a, r);
      } catch (o) {
        u1(`Module.instantiateWasm callback failed with error: ${o}`), t1(o);
      }
      (n = L1) !== null && n !== void 0 || (L1 = I2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : d.locateFile ? d.locateFile("DotLottiePlayer.wasm", j) : j + "DotLottiePlayer.wasm");
      try {
        var s = await c3(a);
        return r(s.instance), s;
      } catch (o) {
        t1(o);
      }
    })();
    var i2 = (e) => (i2 = L.fa)(e), G = (e) => (G = L.ha)(e), J2 = (e) => (J2 = L.ia)(e), q2 = (e, n) => (q2 = L.ja)(e, n), $ = (e, n) => ($ = L.ka)(e, n), H = (e) => (H = L.la)(e), V = () => (V = L.ma)();
    d.dynCall_jiii = (e, n, r, a) => (d.dynCall_jiii = L.na)(e, n, r, a), d.dynCall_jii = (e, n, r) => (d.dynCall_jii = L.oa)(e, n, r), d.dynCall_vjii = (e, n, r, a, s) => (d.dynCall_vjii = L.pa)(e, n, r, a, s), d.dynCall_vjfii = (e, n, r, a, s, o) => (d.dynCall_vjfii = L.qa)(e, n, r, a, s, o), d.dynCall_vjiii = (e, n, r, a, s, o) => (d.dynCall_vjiii = L.ra)(e, n, r, a, s, o), d.dynCall_vj = (e, n, r) => (d.dynCall_vj = L.sa)(e, n, r), d.dynCall_vjiiiii = (e, n, r, a, s, o, c, h) => (d.dynCall_vjiiiii = L.ta)(e, n, r, a, s, o, c, h), d.dynCall_vjiffii = (e, n, r, a, s, o, c, h) => (d.dynCall_vjiffii = L.ua)(e, n, r, a, s, o, c, h), d.dynCall_vjiiii = (e, n, r, a, s, o, c) => (d.dynCall_vjiiii = L.va)(e, n, r, a, s, o, c), d.dynCall_viijii = (e, n, r, a, s, o, c) => (d.dynCall_viijii = L.wa)(e, n, r, a, s, o, c), d.dynCall_iiiiij = (e, n, r, a, s, o, c) => (d.dynCall_iiiiij = L.xa)(e, n, r, a, s, o, c), d.dynCall_iiiiijj = (e, n, r, a, s, o, c, h, f) => (d.dynCall_iiiiijj = L.ya)(e, n, r, a, s, o, c, h, f), d.dynCall_iiiiiijj = (e, n, r, a, s, o, c, h, f, _) => (d.dynCall_iiiiiijj = L.za)(e, n, r, a, s, o, c, h, f, _);
    function H3(e, n) {
      var r = V();
      try {
        return k.get(e)(n);
    ...
    function V3(e, n, r, a, s, o) {
      var c = V();
      try {
        return k.get(e)(n, r, a, s, o);
      } catch (h) {
        if (H(c), h !== h + 0) throw h;
        $(1, 0);
      }
    }
    function j3(e, n) {
    ...
    function K3(e, n, r, a) {
      var s = V();
      try {
        return k.get(e)(n, r, a);
      } catch (o) {
        if (H(s), o !== o + 0) throw o;
        $(1, 0);
      }
    }
    function Y3(e, n, r, a, s) {
      var o = V();
      try {
        k.get(e)(n, r, a, s);
      } catch (c) {
        if (H(o), c !== c + 0) throw c;
        $(1, 0);
      }
    }
    var x1;
    ...
    function K2() {
      function e() {
        if (!x1 && (x1 = true, d.calledRun = true, !y1)) {
          var n;
          if ($1(w2), Q(d), (n = d.onRuntimeInitialized) === null || n === void 0 || n.call(d), d.postRun) for (typeof d.postRun == "function" && (d.postRun = [d.postRun]); d.postRun.length; ) {
      ...
      if (!(0 < Z)) {
        if (d.preRun) for (typeof d.preRun == "function" && (d.preRun = [d.preRun]); d.preRun.length; ) u3();
        $1(L2), 0 < Z || (d.setStatus ? (d.setStatus("Running..."), setTimeout(() => {
...
var K = class {
  ...
  static async _tryLoad(t) {
    return await t3({ locateFile: () => t });
  }
  static async _loadWithBackup() {
    return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (t) => {
      let i = `https://unpkg.com/${u2}@${o2}/dist/dotlottie-player.wasm`;
      console.warn(`Primary WASM load failed from ${this._wasmURL}. Error: ${t.message}`), console.warn(`Attempting to load WASM from backup URL: ${i}`);
      try {
        return await this._tryLoad(i);
      } catch (u) {
        throw console.error(`Primary WASM URL failed: ${t.message}`), console.error(`Backup WASM URL failed: ${u.message}`), new Error("WASM loading failed from all sources.");
      }
    })), this._ModulePromise;
  }
  static async load() {
...
v(K, "_ModulePromise", null), v(K, "_wasmURL", `https://cdn.jsdelivr.net/npm/${u2}@${o2}/dist/dotlottie-player.wasm`);
var o1 = class {
  constructor() {
    v(this, "_eventListeners", /* @__PURE__ */ new Map());
  }
  addEventListener(t, i) {
    let u = this._eventListeners.get(t);
    u || (u = /* @__PURE__ */ new Set(), this._eventListeners.set(t, u)), u.add(i);
  }
  removeEventListener(t, i) {
    let u = this._eventListeners.get(t);
    u && (i ? (u.delete(i), u.size === 0 && this._eventListeners.delete(t)) : this._eventListeners.delete(t));
  }
  dispatch(t) {
    this._eventListeners.get(t.type)?.forEach((u) => u(t));
  }
...
var A = class {
  static _initializeObserver() {
    ...
    let t = (i) => {
      i.forEach((u) => {
        let l = this._observedCanvases.get(u.target);
        l && (u.isIntersecting ? l.unfreeze() : l.freeze());
      });
    };
    this._observer = new IntersectionObserver(t, { threshold: 0 });
  }
  static observe(t, i) {
    this._initializeObserver(), !this._observedCanvases.has(t) && (this._observedCanvases.set(t, i), this._observer?.observe(t));
  }
  static unobserve(t) {
    this._observer?.unobserve(t), this._observedCanvases.delete(t), this._observedCanvases.size === 0 && (this._observer?.disconnect(), this._observer = null);
  }
};
v(A, "_observer", null), v(A, "_observedCanvases", /* @__PURE__ */ new Map());
var F = class {
  static _initializeObserver() {
    if (this._observer) return;
    let t = (i) => {
      i.forEach((u) => {
        ...
        this._observedCanvases.set(u.target, [M, Q]);
      });
    };
    this._observer = new ResizeObserver(t);
  }
  static observe(t, i) {
    this._initializeObserver(), !this._observedCanvases.has(t) && (this._observedCanvases.set(t, [i, 0]), this._observer?.observe(t));
  }
  static unobserve(t) {
    ...
    this._observer?.unobserve(t), this._observedCanvases.delete(t), !this._observedCanvases.size && this._observer && (this._observer.disconnect(), this._observer = null);
  }
};
v(F, "_observer", null), v(F, "_observedCanvases", /* @__PURE__ */ new Map());
function e0(p) {
  return /^#([\da-f]{6}|[\da-f]{8})$/iu.test(p);
}
function i3(p) {
  if (!e0(p)) return 0;
  let t = p.replace("#", "");
...
function d2(p) {
  if (p.byteLength < 4) return false;
  let t = new Uint8Array(p.slice(0, B1.byteLength));
  for (let i = 0; i < B1.length; i += 1) if (B1[i] !== t[i]) return false;
  return true;
}
function n3(p) {
  return X2.every((t) => Object.prototype.hasOwnProperty.call(p, t));
}
function h2(p) {
  if (typeof p == "string") try {
    return n3(JSON.parse(p));
  } catch {
    return false;
  }
  else return n3(p);
...
function J() {
  return 1 + ((I ? window.devicePixelRatio : 1) - 1) * Z2;
}
function Y(p) {
  let t = p.getBoundingClientRect(), i = window.innerHeight || document.documentElement.clientHeight, u = window.innerWidth || document.documentElement.clientWidth;
  return !(t.bottom < 0 || t.top > i || t.right < 0 || t.left > u);
}
function R(p) {
  let t = p.target;
  if (t instanceof HTMLCanvasElement) {
    let i = t.getBoundingClientRect();
    if (i.width === 0 || i.height === 0 || t.width === 0 || t.height === 0) return null;
    let u = t.width / i.width, l = t.height / i.height, M = (p.clientX - i.left) * u, d = (p.clientY - i.top) * l;
    return !Number.isFinite(M) || !Number.isFinite(d) || Number.isNaN(M) || Number.isNaN(d) ? null : { x: M, y: d };
  }
  return null;
}
function U1(p) {
  let t = p.replace("OpenUrl: ", ""), i = t.indexOf(" | Target: "), u, l;
  i === -1 ? (u = t, l = "_blank") : (u = t.substring(0, i), l = t.substring(i + 11)), window.open(u, l);
}
var c2 = (p, t) => {
  let i = new p.VectorChar(), u = new Uint8Array(t);
  for (let l = 0; l < u.length; l += 1) {
    let M = u[l];
    M !== void 0 && typeof M == "number" && i.push_back(M);
  }
  return i;
};
var l2 = (p, t) => p === "reverse" ? t.Mode.Reverse : p === "bounce" ? t.Mode.Bounce : p === "reverse-bounce" ? t.Mode.ReverseBounce : t.Mode.Forward;
var t0 = (p, t) => p === "contain" ? t.Fit.Contain : p === "cover" ? t.Fit.Cover : p === "fill" ? t.Fit.Fill : p === "fit-height" ? t.Fit.FitHeight : p === "fit-width" ? t.Fit.FitWidth : t.Fit.None;
var n0 = (p, t) => {
  let i = new t.VectorFloat();
  return i.push_back(p[0]), i.push_back(p[1]), i;
};
var p2 = (p, t) => {
  let i = new t.VectorFloat();
  return p.length !== 2 || (i.push_back(p[0]), i.push_back(p[1])), i;
};
var f2 = (p, t) => p ? { align: n0(p.align ?? [0.5, 0.5], t), fit: t0(p.fit ?? "contain", t) } : t.createDefaultLayout();
var g = class g2 {
  constructor(t) {
    v(this, "_canvas");
    v(this, "_context", null);
    v(this, "_eventManager");
    v(this, "_animationFrameId", null);
    v(this, "_frameManager");
    v(this, "_dotLottieCore", null);
    v(this, "_stateMachineId", "");
    v(this, "_stateMachineConfig", null);
    v(this, "_isStateMachineRunning", false);
    v(this, "_stateMachineObserverHandle", null);
    v(this, "_stateMachineInternalMessageObserver", null);
    v(this, "_dotLottieObserverHandle", null);
    v(this, "_renderConfig", {});
    v(this, "_isFrozen", false);
    v(this, "_backgroundColor", null);
    v(this, "_boundOnClick", null);
    v(this, "_boundOnPointerUp", null);
    v(this, "_boundOnPointerDown", null);
    v(this, "_boundOnPointerMove", null);
    v(this, "_boundOnPointerEnter", null);
    v(this, "_boundOnPointerLeave", null);
    v(this, "_bufferMismatchCount", 0);
    v(this, "_lastExpectedBufferSize", 0);
    this._canvas = t.canvas, this._eventManager = new o1(), this._frameManager = new k1(), this._renderConfig = { ...t.renderConfig, devicePixelRatio: t.renderConfig?.devicePixelRatio || J(), freezeOnOffscreen: t.renderConfig?.freezeOnOffscreen ?? true }, K.load().then((i) => {
      g2._wasmModule = i;
      let u = new i.CallbackObserver();
      u.setOnLoad(() => {
        setTimeout(() => {
  ...
  async _fetchData(t) {
    ...
    let u = await i.arrayBuffer();
    return d2(u) ? u : new TextDecoder().decode(u);
  }
  _loadFromData(t) {
    if (this._dotLottieCore === null || g2._wasmModule === null) return;
    let i = this._canvas.width, u = this._canvas.height, l = false;
    if (typeof t == "string") {
      if (!h2(t)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      l = this._dotLottieCore.loadAnimationData(t, i, u);
      ...
      l = this._dotLottieCore.loadDotLottieData(c2(g2._wasmModule, t), i, u);
    } else if (typeof t == "object") {
      if (!h2(t)) {
        this._dispatchError("Invalid Lottie JSON object: The provided object does not conform to the Lottie JSON format.");
        return;
      }
      l = this._dotLottieCore.loadAnimationData(JSON.stringify(t), i, u);
    } else {
  ...
  get layout() {
    ...
    if (t) return { align: [t.align.get(0), t.align.get(1)], fit: (() => {
      switch (t.fit) {
        case g2._wasmModule?.Fit.Contain:
          return "contain";
        case g2._wasmModule?.Fit.Cover:
          return "cover";
        case g2._wasmModule?.Fit.Fill:
          return "fill";
        case g2._wasmModule?.Fit.FitHeight:
          return "fit-height";
        case g2._wasmModule?.Fit.FitWidth:
          return "fit-width";
        case g2._wasmModule?.Fit.None:
          return "none";
        default:
          return "contain";
      }
  ...
  get mode() {
    ...
    return t === g2._wasmModule?.Mode.Reverse ? "reverse" : t === g2._wasmModule?.Mode.Bounce ? "bounce" : t === g2._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(t) {
    this._dotLottieCore === null || g2._wasmModule === null || (this._stopAnimationLoop(), I && this._canvas instanceof HTMLCanvasElement && (A.unobserve(this._canvas), F.unobserve(this._canvas), this._cleanupStateMachineListeners()), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: t.animationId ?? "", themeId: t.themeId ?? "", stateMachineId: "", autoplay: t.autoplay ?? false, backgroundColor: 0, loopAnimation: t.loop ?? false, loopCount: t.loopCount ?? 0, mode: l2(t.mode ?? "forward", g2._wasmModule), segment: p2(t.segment ?? [], g2._wasmModule), speed: t.speed ?? 1, useFrameInterpolation: t.useFrameInterpolation ?? true, marker: t.marker ?? "", layout: f2(t.layout, g2._wasmModule) }), t.data ? this._loadFromData(t.data) : t.src && this._loadFromSrc(t.src), this.setBackgroundColor(t.backgroundColor ?? ""));
  }
  _draw() {
    if (this._dotLottieCore !== null && (!this._context && "getContext" in this._canvas && typeof this._canvas.getContext == "function" && (this._context = this._canvas.getContext("2d")), this._context)) {
      let t = this._dotLottieCore.buffer(), i = this._canvas.width * this._canvas.height * e3;
      if (t.byteLength !== i) {
      ...
      let u = null, l = new Uint8ClampedArray(t, 0, t.byteLength);
      typeof ImageData > "u" ? (u = this._context.createImageData(this._canvas.width, this._canvas.height), u.data.set(l)) : u = new ImageData(l, this._canvas.width, this._canvas.height), this._context.putImageData(u, 0, 0);
    }
  }
  _stopAnimationLoop() {
  ...
  _animationLoop() {
    ...
    try {
      ...
      console.error("Error in animation frame:", t), this._eventManager.dispatch({ type: "renderError", error: t }), t instanceof WebAssembly.RuntimeError && this.destroy();
    }
  }
  play() {
    if (this._dotLottieCore === null || !this.isLoaded) return;
    this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), I && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !Y(this._canvas) && this.freeze();
  }
  pause() {
  ...
  stop() {
    ...
    this._stopAnimationLoop(), t && (this._eventManager.dispatch({ type: "frame", currentFrame: this.currentFrame }), this._dotLottieCore.render(), this._draw());
  }
  setFrame(t) {
    if (this._dotLottieCore === null) return;
    this._dotLottieCore.seek(t) && this._dotLottieCore.render() && this._draw();
  }
  setSpeed(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), speed: t });
  }
  setBackgroundColor(t) {
    this._dotLottieCore !== null && (I && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = t : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: i3(t) }), this._backgroundColor = t);
  }
  setLoop(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), loopAnimation: t });
  }
  setLoopCount(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), loopCount: t });
  }
  setUseFrameInterpolation(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), useFrameInterpolation: t });
  }
  addEventListener(t, i) {
  ...
  resize() {
    ...
    if (I && this._canvas instanceof HTMLCanvasElement) {
      let i = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: u, width: l } = this._canvas.getBoundingClientRect();
      u !== 0 && l !== 0 && (this._canvas.width = l * i, this._canvas.height = u * i);
    }
    this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
  }
  setTransform(t) {
    if (!this._dotLottieCore || !g2._wasmModule) return false;
    let i = new g2._wasmModule.VectorFloat();
    for (let l of t) i.push_back(l);
    let u = this._dotLottieCore.setTransform(i);
    return u && this._dotLottieCore.render() && this._draw(), u;
  }
  getTransform() {
    if (!this._dotLottieCore) return;
    let t = [0, 0, 0, 0, 0, 0, 0, 0, 0], i = this._dotLottieCore.getTransform();
    for (let u = 0; u < i.size(); u += 1) t[u] = i.get(u);
    return t;
  }
  setSegment(t, i) {
    this._dotLottieCore === null || g2._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: p2([t, i], g2._wasmModule) });
  }
  setMode(t) {
    this._dotLottieCore === null || g2._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: l2(t, g2._wasmModule) });
  }
  setRenderConfig(t) {
    let { devicePixelRatio: i, freezeOnOffscreen: u, quality: l, ...M } = t;
    this._renderConfig = { ...this._renderConfig, ...M, devicePixelRatio: i || J(), freezeOnOffscreen: u ?? true, ...l !== void 0 && { quality: l } }, l !== void 0 && this._dotLottieCore && this._dotLottieCore.setQuality(l), I && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? F.observe(this._canvas, this) : F.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (A.observe(this._canvas, this), Y(this._canvas) || this.freeze()) : (A.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(t) {
    if (this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === t) return;
    this._dotLottieCore.loadAnimation(t, this._canvas.width, this._canvas.height) && (this._renderConfig.quality !== void 0 && this._dotLottieCore.setQuality(this._renderConfig.quality), this.resize());
  }
  setMarker(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), marker: t });
  }
  markers() {
    let t = this._dotLottieCore?.markers();
    if (t) {
      let i = [];
      for (let u = 0; u < t.size(); u += 1) {
        let l = t.get(u);
        i.push({ name: l.name, time: l.time, duration: l.duration });
      }
      return i;
    }
    return [];
  ...
  resetTheme() {
    if (this._dotLottieCore === null) return false;
    let t = this._dotLottieCore.resetTheme();
  ...
  setSlots(t) {
    this._dotLottieCore !== null && this._dotLottieCore.setSlots(t) && (this._dotLottieCore.render(), this._draw());
  }
  setLayout(t) {
    this._dotLottieCore === null || g2._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: f2(t, g2._wasmModule) });
  }
  setViewport(t, i, u, l) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(t, i, u, l);
  }
  static setWasmUrl(t) {
    K.setWasmUrl(t);
  }
  static async registerFont(t, i) {
    try {
      let u = await K.load(), l;
      if (typeof i == "string") {
        let d = await fetch(i);
        if (!d.ok) return console.error(`Failed to fetch font from URL: ${i}. Status: ${d.status}`), false;
        l = await d.arrayBuffer();
      } else if (i instanceof Uint8Array) {
        let d = i.buffer.slice(i.byteOffset, i.byteOffset + i.byteLength);
        d instanceof ArrayBuffer ? l = d : (l = new ArrayBuffer(i.byteLength), new Uint8Array(l).set(i));
      } else l = i;
      let M = u.registerFont(t, c2(u, l));
      return M || console.error(`Failed to register font "${t}". Font data may be invalid.`), M;
    } catch (u) {
      return console.error(`Error registering font "${t}":`, u), false;
    }
  }
  tween(t, i) {
    if (!g2._wasmModule) return false;
    let u = [0, 0, 1, 1], l = new g2._wasmModule.VectorFloat();
    for (let M of u) l.push_back(M);
    return this._dotLottieCore?.tween(t, i, l) ?? false;
  }
  tweenToMarker(t, i) {
    if (!g2._wasmModule) return false;
    let u = [0, 0, 1, 1], l = new g2._wasmModule.VectorFloat();
    for (let M of u) l.push_back(M);
    return this._dotLottieCore?.tweenToMarker(t, i, l) ?? false;
  }
  animationSize() {
    let t = this._dotLottieCore?.animationSize().get(0) ?? 0, i = this._dotLottieCore?.animationSize().get(1) ?? 0;
    return { width: t, height: i };
  }
  getLayerBoundingBox(t) {
    let i = this._dotLottieCore?.getLayerBounds(t);
    if (!i || i.size() !== 8) return;
    let u = [];
    for (let l = 0; l < 8; l += 1) u.push(i.get(l));
    return u;
  }
  static transformThemeToLottieSlots(t, i) {
    return g2._wasmModule?.transformThemeToLottieSlots(t, i) ?? "";
  }
  _setupStateMachineObservers() {
    if (!this._dotLottieCore || !g2._wasmModule) return;
    let t = new g2._wasmModule.CallbackStateMachineObserver();
    t.setOnStart(() => {
      setTimeout(() => {
    ...
    }), t.setOnCustomEvent((u) => {
      this._eventManager.dispatch({ type: "stateMachineCustomEvent", eventName: u });
    }), t.setOnBooleanInputValueChange((u, l, M) => {
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: u, newValue: M, oldValue: l });
    }), t.setOnNumericInputValueChange((u, l, M) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: u, newValue: M, oldValue: l });
    }), t.setOnStringInputValueChange((u, l, M) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: u, newValue: M, oldValue: l });
    }), t.setOnInputFired((u) => {
      this._eventManager.dispatch({ type: "stateMachineInputFired", inputName: u });
    }), t.setOnTransition((u, l) => {
      this._eventManager.dispatch({ type: "stateMachineTransition", fromState: u, toState: l });
    }), t.setOnStateEntered((u) => {
    ...
    let i = new g2._wasmModule.CallbackStateMachineInternalObserver();
    i.setOnMessage((u) => {
      I ? u.startsWith("OpenUrl: ") && U1(u) : this._eventManager.dispatch({ type: "stateMachineInternalMessage", message: u });
    }), this._stateMachineObserverHandle = this._dotLottieCore.stateMachineSubscribe(t), this._stateMachineInternalMessageObserver = this._dotLottieCore.stateMachineInternalSubscribe(i);
  }
  ...
  stateMachineLoad(t) {
    ...
    let i = this._dotLottieCore.stateMachineLoad(t);
    return i && this._setupStateMachineObservers(), i;
  }
  stateMachineLoadData(t) {
    if (!this._dotLottieCore || !g2._wasmModule) return false;
    this._cleanupStateMachineObservers();
    let i = this._dotLottieCore.stateMachineLoadData(t);
    return i && this._setupStateMachineObservers(), i;
  }
  ...
  stateMachineStart() {
    if (g2._wasmModule === null || this._dotLottieCore === null) return false;
    let t = g2._wasmModule.createDefaultOpenUrlPolicy();
    if (this._stateMachineConfig) {
      let u = this._stateMachineConfig.openUrlPolicy;
      if (u && typeof u.requireUserInteraction == "boolean" && (t.requireUserInteraction = u.requireUserInteraction), u?.whitelist) {
        t.whitelist = new g2._wasmModule.VectorString();
        for (let l of u.whitelist) t.whitelist.push_back(l);
      }
    }
    let i = this._dotLottieCore.stateMachineStart(t);
    return i && (this._isStateMachineRunning = true, this._setupStateMachineListeners(), this._startAnimationLoop()), i;
  }
  stateMachineStop() {
    if (!this._dotLottieCore) return false;
    let t = this._dotLottieCore.stateMachineStop();
    return t && (this._cleanupStateMachineObservers(), this._isStateMachineRunning = false, this._cleanupStateMachineListeners(), this._dotLottieCore.isPlaying() || this._stopAnimationLoop()), t;
  }
  ...
  stateMachineOverrideState(t, i = false) {
    return this._dotLottieCore?.stateMachineOverrideCurrentState(t, i) ?? false;
  }
  stateMachineGet(t) {
    return this._dotLottieCore?.getStateMachine(t) ?? "";
  }
  stateMachineGetListeners() {
    if (!this._dotLottieCore) return [];
    let t = this._dotLottieCore.stateMachineFrameworkSetup(), i = [];
    for (let u = 0; u < t.size(); u += 1) i.push(t.get(u));
    return i;
  }
  stateMachineSetBooleanInput(t, i) {
    return this._dotLottieCore?.stateMachineSetBooleanInput(t, i) ?? false;
  }
  stateMachineSetNumericInput(t, i) {
    return this._dotLottieCore?.stateMachineSetNumericInput(t, i) ?? false;
  }
  stateMachineSetStringInput(t, i) {
    return this._dotLottieCore?.stateMachineSetStringInput(t, i) ?? false;
  }
  stateMachineGetBooleanInput(t) {
    return this._dotLottieCore?.stateMachineGetBooleanInput(t);
  }
  stateMachineGetNumericInput(t) {
    return this._dotLottieCore?.stateMachineGetNumericInput(t);
  }
  stateMachineGetStringInput(t) {
    return this._dotLottieCore?.stateMachineGetStringInput(t);
  }
  stateMachineGetInputs() {
    if (!this._dotLottieCore) return [];
    let t = this._dotLottieCore.stateMachineGetInputs(), i = [];
    for (let u = 0; u < t.size(); u += 1) i.push(t.get(u));
    return i;
  }
  stateMachineFireEvent(t) {
    this._dotLottieCore?.stateMachineFireEvent(t);
  }
  stateMachinePostClickEvent(t, i) {
    this._dotLottieCore?.stateMachinePostClickEvent(t, i);
  }
  stateMachinePostPointerUpEvent(t, i) {
    this._dotLottieCore?.stateMachinePostPointerUpEvent(t, i);
  }
  stateMachinePostPointerDownEvent(t, i) {
    this._dotLottieCore?.stateMachinePostPointerDownEvent(t, i);
  }
  stateMachinePostPointerMoveEvent(t, i) {
    this._dotLottieCore?.stateMachinePostPointerMoveEvent(t, i);
  }
  stateMachinePostPointerEnterEvent(t, i) {
    this._dotLottieCore?.stateMachinePostPointerEnterEvent(t, i);
  }
  stateMachinePostPointerExitEvent(t, i) {
    this._dotLottieCore?.stateMachinePostPointerExitEvent(t, i);
  }
  _onClick(t) {
    let i = R(t);
    i && this.stateMachinePostClickEvent(i.x, i.y);
  }
  _onPointerUp(t) {
    let i = R(t);
    i && this.stateMachinePostPointerUpEvent(i.x, i.y);
  }
  _onPointerDown(t) {
    let i = R(t);
    i && this.stateMachinePostPointerDownEvent(i.x, i.y);
  }
  _onPointerMove(t) {
    let i = R(t);
    i && this.stateMachinePostPointerMoveEvent(i.x, i.y);
  }
  _onPointerEnter(t) {
    let i = R(t);
    i && this.stateMachinePostPointerEnterEvent(i.x, i.y);
  }
  _onPointerLeave(t) {
    let i = R(t);
    i && this.stateMachinePostPointerExitEvent(i.x, i.y);
  }
...
var v2 = class {
  constructor() {
    ...
    return URL.revokeObjectURL(i), u;
  }
};
var a3 = v2;
var z1 = class {
  constructor() {
    v(this, "_workers", /* @__PURE__ */ new Map());
    v(this, "_animationWorkerMap", /* @__PURE__ */ new Map());
  }
  getWorker(t) {
    return this._workers.has(t) || this._workers.set(t, new a3()), this._workers.get(t);
  }
  assignAnimationToWorker(t, i) {
    this._animationWorkerMap.set(t, i);
  }
  unassignAnimationFromWorker(t) {
    this._animationWorkerMap.delete(t);
  }
  sendMessage(t, i, u) {
    this.getWorker(t).postMessage(i, u || []);
  }
  broadcastMessage(t, i) {
    this._workers.forEach((u) => {
      u.postMessage(t, i || []);
    });
  }
  terminateWorker(t) {
    let i = this._workers.get(t);
    i && (i.terminate(), this._workers.delete(t));
  }
};
function s3(p, t) {
  if (p instanceof HTMLCanvasElement) {
    let { height: i, width: u } = p.getBoundingClientRect();
    if (i !== 0 && u !== 0) return { width: u * t, height: i * t };
  }
...
var W = class W2 {
  constructor(t) {
    ...
    v(this, "_boundOnPointerEnter", null);
    v(this, "_boundOnPointerLeave", null);
    this._canvas = t.canvas, this._id = `dotlottie-${m2()}`;
    let i = t.workerId || "defaultWorker";
    this._worker = W2._workerManager.getWorker(i), W2._workerManager.assignAnimationToWorker(this._id, i), W2._wasmUrl && this._sendMessage("setWasmUrl", { url: W2._wasmUrl }), this._create({ ...t, renderConfig: { ...t.renderConfig, devicePixelRatio: t.renderConfig?.devicePixelRatio || J(), freezeOnOffscreen: t.renderConfig?.freezeOnOffscreen ?? true } }), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this));
  }
  async _handleWorkerEvent(t) {
    ...
    if (!i.id && (i.method === "onLoad" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event), I && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && (A.observe(this._canvas, this), Y(this._canvas) || await this.freeze()), this._dotLottieInstanceState.renderConfig.autoResize && F.observe(this._canvas, this))), i.method === "onComplete" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onDestroy" && i.result.instanceId === this._id && this._eventManager.dispatch(i.result.event), i.method === "onUnfreeze" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._dotLottieInstanceState.isFrozen = false, this._eventManager.dispatch(i.result.event)), i.method === "onFrame" && i.result.instanceId === this._id && (this._dotLottieInstanceState.currentFrame = i.result.event.currentFrame, this._eventManager.dispatch(i.result.event)), i.method === "onRender" && i.result.instanceId === this._id && this._eventManager.dispatch(i.result.event), i.method === "onFreeze" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onPause" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onPlay" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStop" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onLoadError" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onRenderError" && i.result.instanceId === this._id && this._eventManager.dispatch(i.result.event), i.method === "onReady" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onLoop" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineStart" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._setupStateMachineListeners(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineStop" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._cleanupStateMachineListeners(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineTransition" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineStateEntered" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineStateExit" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineCustomEvent" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineError" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineBooleanInputValueChange" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineNumericInputValueChange" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineStringInputValueChange" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineInputFired" && i.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(i.result.event)), i.method === "onStateMachineInternalMessage" && i.result.instanceId === this._id)) {
      ...
      let u = i.result.event;
      u.message.startsWith("OpenUrl: ") && U1(u.message);
    }
  }
  async _create(t) {
    let i;
    this._canvas instanceof HTMLCanvasElement ? i = this._canvas.transferControlToOffscreen() : i = this._canvas;
    let { instanceId: u } = await this._sendMessage("create", { instanceId: this._id, config: { ...t, canvas: i }, ...s3(this._canvas, t.renderConfig?.devicePixelRatio || J()) }, [i]);
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), I && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !Y(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setSpeed(t) {
    this._created && (await this._sendMessage("setSpeed", { instanceId: this._id, speed: t }), await this._updateDotLottieInstanceState());
  }
  async setMode(t) {
    this._created && (await this._sendMessage("setMode", { instanceId: this._id, mode: t }), await this._updateDotLottieInstanceState());
  }
  async setFrame(t) {
    this._created && (await this._sendMessage("setFrame", { frame: t, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setSegment(t, i) {
    this._created && (await this._sendMessage("setSegment", { instanceId: this._id, segment: [t, i] }), await this._updateDotLottieInstanceState());
  }
  ...
  async setUseFrameInterpolation(t) {
    this._created && (await this._sendMessage("setUseFrameInterpolation", { instanceId: this._id, useFrameInterpolation: t }), await this._updateDotLottieInstanceState());
  }
  async setTheme(t) {
  ...
  async setLoop(t) {
    this._created && (await this._sendMessage("setLoop", { instanceId: this._id, loop: t }), await this._updateDotLottieInstanceState());
  }
  async setLoopCount(t) {
    this._created && (await this._sendMessage("setLoopCount", { instanceId: this._id, loopCount: t }), await this._updateDotLottieInstanceState());
  }
  async resize() {
    if (!this._created) return;
    let { height: t, width: i } = s3(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || J());
    await this._sendMessage("resize", { height: t, instanceId: this._id, width: i }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), W2._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), I && this._canvas instanceof HTMLCanvasElement && (A.unobserve(this._canvas), F.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async setBackgroundColor(t) {
    this._created && (await this._sendMessage("setBackgroundColor", { instanceId: this._id, backgroundColor: t }), await this._updateDotLottieInstanceState());
  }
  async loadAnimation(t) {
    this._created && (await this._sendMessage("loadAnimation", { animationId: t, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setLayout(t) {
    this._created && (await this._sendMessage("setLayout", { instanceId: this._id, layout: t }), await this._updateDotLottieInstanceState());
  }
  async _updateDotLottieInstanceState() {
    if (!this._created) return;
    let t = await this._sendMessage("getDotLottieInstanceState", { instanceId: this._id });
  ...
  async setMarker(t) {
    this._created && (await this._sendMessage("setMarker", { instanceId: this._id, marker: t }), await this._updateDotLottieInstanceState());
  }
  async setThemeData(t) {
    if (!this._created) return false;
    let i = await this._sendMessage("setThemeData", { instanceId: this._id, themeData: t });
    return await this._updateDotLottieInstanceState(), i;
  }
  async setViewport(t, i, u, l) {
    return this._created ? this._sendMessage("setViewport", { x: t, y: i, width: u, height: l, instanceId: this._id }) : false;
  }
  async animationSize() {
    return this._created ? this._sendMessage("animationSize", { instanceId: this._id }) : { height: 0, width: 0 };
  }
  async tween(t, i) {
    return this._created ? this._sendMessage("tween", { instanceId: this._id, frame: t, duration: i }) : false;
  }
  async tweenToMarker(t, i) {
    return this._created ? this._sendMessage("tweenToMarker", { instanceId: this._id, marker: t, duration: i }) : false;
  }
  async setTransform(t) {
    return this._created ? this._sendMessage("setTransform", { instanceId: this._id, transform: t }) : false;
  }
  async getTransform() {
    if (this._created) return this._sendMessage("getTransform", { instanceId: this._id });
  }
  async _sendMessage(t, i, u) {
    let l = { id: `dotlottie-request-${m2()}`, method: t, params: i };
    return this._worker.postMessage(l, u || []), new Promise((M, d) => {
      let Q = (t1) => {
        let n1 = t1.data;
        n1.id === l.id && (this._worker.removeEventListener("message", Q), n1.error ? d(new Error(`Failed to execute method ${t}: ${n1.error}`)) : M(n1.result));
      };
      this._worker.addEventListener("message", Q);
    });
  }
  addEventListener(t, i) {
    this._eventManager.addEventListener(t, i);
  ...
  static async registerFont(t, i) {
    try {
      let u = m2();
      return W2._workerManager.broadcastMessage({ id: u, method: "registerFont", params: { fontName: t, fontSource: i } }), true;
    } catch (u) {
      return console.error(`Error broadcasting registerFont for "${t}":`, u), false;
    }
  }
  async stateMachineLoad(t) {
    if (!this._created) return false;
    let i = await this._sendMessage("stateMachineLoad", { instanceId: this._id, stateMachineId: t });
    return await this._updateDotLottieInstanceState(), i;
  }
  async stateMachineLoadData(t) {
    if (!this._created) return false;
    let i = await this._sendMessage("stateMachineLoadData", { instanceId: this._id, stateMachineData: t });
    return await this._updateDotLottieInstanceState(), i;
  }
  async stateMachineStart() {
    if (!this._created) return false;
    let t = await this._sendMessage("stateMachineStart", { instanceId: this._id });
    return t && (this._setupStateMachineListeners(), await this._updateDotLottieInstanceState()), t;
  }
  ...
  async stateMachineSetNumericInput(t, i) {
    return this._created ? this._sendMessage("stateMachineSetNumericInput", { instanceId: this._id, name: t, value: i }) : false;
  }
  async stateMachineSetBooleanInput(t, i) {
    return this._created ? this._sendMessage("stateMachineSetBooleanInput", { instanceId: this._id, name: t, value: i }) : false;
  }
  async stateMachineSetConfig(t) {
    this._created && this._sendMessage("stateMachineSetConfig", { instanceId: this._id, config: t });
  }
  async stateMachineSetStringInput(t, i) {
    return this._created ? this._sendMessage("stateMachineSetStringInput", { instanceId: this._id, name: t, value: i }) : false;
  }
  async stateMachineGetNumericInput(t) {
    if (this._created) return this._sendMessage("stateMachineGetNumericInput", { instanceId: this._id, name: t });
  }
  async stateMachineGetBooleanInput(t) {
    if (this._created) return this._sendMessage("stateMachineGetBooleanInput", { instanceId: this._id, name: t });
  }
  async stateMachineGetStringInput(t) {
    if (this._created) return this._sendMessage("stateMachineGetStringInput", { instanceId: this._id, name: t });
  }
  ...
  async stateMachineFireEvent(t) {
    this._created && this._sendMessage("stateMachineFireEvent", { instanceId: this._id, name: t });
  }
  ...
  async stateMachineOverrideState(t, i = false) {
    return this._created ? this._sendMessage("stateMachineOverrideState", { instanceId: this._id, state: t, immediate: i }) : false;
  }
  async stateMachineGet(t) {
    return this._created ? this._sendMessage("stateMachineGet", { instanceId: this._id, stateMachineId: t }) : "";
  }
  async stateMachineGetListeners() {
    return this._created ? this._sendMessage("stateMachineGetListeners", { instanceId: this._id }) : [];
  }
  async stateMachinePostClickEvent(t, i) {
    if (this._created) return this._sendMessage("stateMachinePostClickEvent", { instanceId: this._id, x: t, y: i });
  }
  async stateMachinePostPointerUpEvent(t, i) {
    if (this._created) return this._sendMessage("stateMachinePostPointerUpEvent", { instanceId: this._id, x: t, y: i });
  }
  async stateMachinePostPointerDownEvent(t, i) {
    if (this._created) return this._sendMessage("stateMachinePostPointerDownEvent", { instanceId: this._id, x: t, y: i });
  }
  async stateMachinePostPointerMoveEvent(t, i) {
    if (this._created) return this._sendMessage("stateMachinePostPointerMoveEvent", { instanceId: this._id, x: t, y: i });
  }
  async stateMachinePostPointerEnterEvent(t, i) {
    if (this._created) return this._sendMessage("stateMachinePostPointerEnterEvent", { instanceId: this._id, x: t, y: i });
  }
  async stateMachinePostPointerExitEvent(t, i) {
    if (this._created) return this._sendMessage("stateMachinePostPointerExitEvent", { instanceId: this._id, x: t, y: i });
  }
  _onClick(t) {
    let i = R(t);
    i && this._sendMessage("stateMachinePostClickEvent", { instanceId: this._id, x: i.x, y: i.y });
  }
  _onPointerUp(t) {
    let i = R(t);
    i && this._sendMessage("stateMachinePostPointerUpEvent", { instanceId: this._id, x: i.x, y: i.y });
  }
  _onPointerDown(t) {
    let i = R(t);
    i && this._sendMessage("stateMachinePostPointerDownEvent", { instanceId: this._id, x: i.x, y: i.y });
  }
  _onPointerMove(t) {
    let i = R(t);
    i && this._sendMessage("stateMachinePostPointerMoveEvent", { instanceId: this._id, x: i.x, y: i.y });
  }
  _onPointerEnter(t) {
    let i = R(t);
    i && this._sendMessage("stateMachinePostPointerEnterEvent", { instanceId: this._id, x: i.x, y: i.y });
  }
  _onPointerLeave(t) {
    let i = R(t);
    i && this._sendMessage("stateMachinePostPointerExitEvent", { instanceId: this._id, x: i.x, y: i.y });
  }
  async _setupStateMachineListeners() {
    if (I && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
      let t = await this._sendMessage("stateMachineGetListeners", { instanceId: this._id });
...
v(W, "_workerManager", new z1()), v(W, "_wasmUrl", "");
var o3 = W;
export {
  r3 as DotLottie,
  o3 as DotLottieWorker
};
